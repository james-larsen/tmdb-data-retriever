...
def read_output_file_flags(_output_files_config_path):
    ...
    titles = db_config[config_entry]['titles']
    title_genres = db_config[config_entry]['title_genres']
    genres = db_config[config_entry]['genres']
    title_spoken_languages = db_config[config_entry]['title_spoken_languages']
    spoken_languages = db_config[config_entry]['spoken_languages']
    title_production_countries = db_config[config_entry]['title_production_countries']
    production_countries = db_config[config_entry]['production_countries']
    title_production_companies = db_config[config_entry]['title_production_companies']
    production_companies = db_config[config_entry]['production_companies']
    title_collections = db_config[config_entry]['title_collections']
    collections = db_config[config_entry]['collections']
    title_keywords = db_config[config_entry]['title_keywords']
    keywords = db_config[config_entry]['keywords']
    persons = db_config[config_entry]['persons']
    person_aka = db_config[config_entry]['person_aka']
    title_cast = db_config[config_entry]['title_cast']
    title_images = db_config[config_entry]['title_images']
    title_removed = db_config[config_entry]['title_removed']
    person_removed = db_config[config_entry]['person_removed']
